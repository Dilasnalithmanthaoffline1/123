...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/21d51a68b00111e491af7.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *𝙴𝚟𝚒𝚕 𝚁𝚘𝚋𝚘𝚝*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/misalexarobot?startgroup=true"),
    ],
     [
     ...
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/AnieBotsupports"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨🇮🇳", url="https://github.com/shiwabot"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *Alexa 𝚁𝚘𝚋𝚘𝚝* [👿](https://telegra.ph/file/21d51a68b00111e491af7.jpg)
